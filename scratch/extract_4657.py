...
output_file = "/home/ccl/Code/teeteestock-web/scratch/page_4657.tsx"
            ...
            try:
                ...
                if len(original_lines) > 0:
                    ...
                    with open(output_file, "w", encoding="utf-8") as out:
                        out.write(code)
                    print(f"Step 4657 successfully written ({len(cleaned_lines)} lines)")
                else:
                    print("Step 4657 has no line-numbered lines.")
